package  {
    ...
    public class Main extends MovieClip {
		...
		var player_1stJumpHeight:Number = -12;			//	The first jump height
		...
		var player_bounciness:Number = -0.3;			//	How bouncy the player will be if player_bounce is true
		...
		function onEnterFrameHandler (e:Event) {
			...
			if (collisions.ground.hitTestPoint(player.x, player.y, true)) {
			...
			if (collisions.ground.hitTestPoint(player.x - player.width/2, player.y - player.height/2, true)) {
			...
			if (collisions.ground.hitTestPoint(player.x, player.y - player.height, true)) {
